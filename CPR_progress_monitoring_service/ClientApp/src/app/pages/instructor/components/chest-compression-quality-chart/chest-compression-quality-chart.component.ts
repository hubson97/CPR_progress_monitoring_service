...
@Component({
  selector: 'app-chest-compression-quality-chart',
  templateUrl: './chest-compression-quality-chart.component.html',
  styleUrls: ['./chest-compression-quality-chart.component.scss']
})
export class ChestCompressionQualityChartComponent implements OnInit {
