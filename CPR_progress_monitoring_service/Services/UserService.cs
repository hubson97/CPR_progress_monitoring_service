...
namespace CPR_progress_monitoring_service.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<AuthenticationModel> GetTokenAsync(TokenRequestModel model)
        {
            ...
            if(user == null)
            {
                ...
                authenticationModel.Message = $"No accounts registered with email {model.Email}";
        ...
        public async Task<string> AddRoleAsync(AddRoleModel model)
        {
            ...
            if(user == null)
            {
                return $"No accounts registered with email {model.Email}";
            }
            if( await _userManager.CheckPasswordAsync(user,model.Password))
            {
                ...
                if(roleExists)
                {
                    ...
                    return $"Added '{model.Role}' role to user {user.Email}";
                }
